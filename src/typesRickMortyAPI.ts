// To parse this data:
//
//   import { Convert, RickandMortyAPI } from "./file";
//
//   const RickandMortyAPI = Convert.toRickandMortyAPI(json);
//
...
export class Convert {
    public static toRickandMortyAPI(json: string): RickandMortyAPI {
        return cast(JSON.parse(json), r("RickandMortyAPI"));
    }

    public static RickandMortyAPIToJson(value: RickandMortyAPI): string {
        return JSON.stringify(uncast(value, r("RickandMortyAPI")), null, 2);
    }
}
